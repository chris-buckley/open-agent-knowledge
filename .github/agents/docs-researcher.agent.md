...
description: "Read-only worker for accelerator-researcher: searches Microsoft Learn for documentation that answers one question and returns one finding per line with its page link."
tools:
