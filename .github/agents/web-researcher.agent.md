---
name: web-researcher
description: "Read-only worker for accelerator-researcher: searches the web with Exa for pages that answer one question and returns one finding per line with its page link."
tools:
  - exa/web_search_exa
  - exa/web_fetch_exa
---
