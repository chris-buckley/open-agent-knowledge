...
description: "Read-only worker for accelerator-researcher: finds GitHub repositories and Microsoft solution accelerators that answer one question and returns one finding per line with its repository link."
tools:
  - web
