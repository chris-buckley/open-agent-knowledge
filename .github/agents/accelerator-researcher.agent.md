---
name: accelerator-researcher
description: "Answers one question about Microsoft solution accelerators: sends it to the github-researcher, web-researcher, and docs-researcher agents at once, has the findings-challenger agent attack their findings, and returns a brief report that starts with a TLDR and links every finding."
tools:
  - agent
---
