...
delegation-requested(
  event="Delegate the task review.",
  source=interface.review-request,
  process=process.delegate-review,
)
</triggers>
...
ACT TOOL "agent.reviewer" input="task_reviewer.oak.md#schema.review-request" output="task_reviewer.oak.md#schema.task-review": Review <TASK_BRIEF>, <IMPLEMENTATION_REPORT>, and <DIFF> in one worker agent and produce <SPEC_COMPLIANCE>, <STRENGTHS>, <ISSUES>, and <ASSESSMENT>. (
  TASK_BRIEF=$TASK_BRIEF,
  IMPLEMENTATION_REPORT=$IMPLEMENTATION_REPORT,
  DIFF=$DIFF,
) -> SPEC_COMPLIANCE, STRENGTHS, ISSUES, ASSESSMENT
</process>
