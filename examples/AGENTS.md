...
- Keep native agent instructions source-owned and locally complete. Distinguish repository-only
  parallel fixtures from native-client behavior; generated agent scenarios contain
  knowledge and TOML, not their Python demonstration hosts.
