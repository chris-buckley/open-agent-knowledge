...
EXPRESSION_SURFACES = {
    ...
    "statement-emit-inferred": '"EMIT", local_interface_target, logical_nl',
    "statement-emit-explicit": '"EMIT", local_interface_target, binding_list, logical_nl',
    "statement-set": "set_statement",
    "statement-fail": "fail_statement",
