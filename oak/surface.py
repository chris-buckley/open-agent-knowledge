...
SURFACES = (
    ...
    _surface("act-native", Act, "ACT <INSTRUCTION> (<INPUTS>) -> <OUTPUTS>", rendered=("instruction", "inputs", "outputs"), fixed=("kind",), omitted=("tool",), when=(("tool", None),)),
    _surface("act-tool", Act, 'ACT TOOL "<TOOL>": <INSTRUCTION> (<INPUTS>) -> <OUTPUTS>', rendered=("tool", "instruction", "inputs", "outputs"), fixed=("kind",), when=(("tool", _PRESENT),)),
