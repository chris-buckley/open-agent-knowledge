...
from oak.render.oak.syntax import interface_body, named_value_line, process_lines, trigger_line
...
def node_xml(node: Node) -> str:
    ...
    parts = [
        ...
        _entries("triggers", [trigger_line(trigger) for trigger in node.triggers]),
