...
Fixed-cardinality examples; choose or combine shapes as needed.

<schema id="option-comparison">
...
ACT Use <EXAMPLES> to choose suitable schema shapes and derive <DRAFT> from the supplied source. (EXAMPLES=$constant.schema-examples) -> DRAFT
