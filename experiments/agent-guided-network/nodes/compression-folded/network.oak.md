...
kernel-meaning: "Finite numerical encodings, not executable code."
</constants>

<triggers>
request(
  event="A compact two-hop retrieval request arrives.",
...
<processes>
<process id="infer" name="Infer classes" input="contracts.oak.md#schema.input" output="contracts.oak.md#schema.prediction">
...
ACT TOOL "tensor.softmax.v1" input="contracts.oak.md#schema.decode" output="contracts.oak.md#schema.prediction": Normalise <LOGITS> to <PROB>. (
  LOGITS=$LOGITS,
) -> PROB
